  ...
  return (
    <div style={{ padding: "28px 32px", overflowY: "auto", flex: 1 }}>
      ...
      <div style={{ background: "#FFFBEB", border: "1px solid #FDE68A", borderRadius: 9, padding: "10px 16px", marginBottom: 18, fontSize: 12, color: "#B45309" }}>
        <strong>Stress Immune Memory — Conceptual feature.</strong> This is a deterministic comparison of past events to the current case. It is not a trained predictive model.
      </div>

      <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: 20 }}>
        {/* Event list */}
        <div>
          <div style={{ fontSize: 11, fontWeight: 700, color: "#687588", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 10 }}>
            Historical Events
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {historyEvents.map((ev) => (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
                  ...
                  <span
                    style={{
                      fontSize: 10,
                      fontWeight: 600,
                      color: ev.outcome === "Recovered" ? "#168568" : "#D84C4C",
                      background: ev.outcome === "Recovered" ? "#DCFCE7" : "#FEE2E2",
                      padding: "1px 7px",
                      borderRadius: 99,
                    }}
                  >
                ...
                <div style={{ fontSize: 11, color: "#687588" }}>
                  {ev.year} • Group {ev.group} • {ev.borrower}
                </div>
        ...
        <div>
          <div style={{ background: "#FFFFFF", border: "1px solid #E3E8EF", borderRadius: 12, padding: "20px", marginBottom: 16 }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: 10, marginBottom: 8 }}>
              ...
              <div style={{ fontSize: 12, color: "#687588" }}>
                {selected.year} • {selected.duration} • Group {selected.group}
              </div>
            </div>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            >
              <ArrowLeft size={13} /> Intervention
            </button>
            <button
